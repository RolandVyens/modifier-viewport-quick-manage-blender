bl_info = {
    "name": "modifier viewport quick manage tool",
...
def disable_particles_in_viewport():
    selected_objects = bpy.context.selected_objects
...
def enable_particles_in_viewport():
    selected_objects = bpy.context.selected_objects
...
class OBJECT_OT_disable_particle_in_viewport(bpy.types.Operator):
    bl_idname = "object.disable_particles_in_viewport"
    bl_label = "Disable Particles in Viewport"
    bl_description = (
        "Disable all selected objects' subdivision modifiers in the viewport"
    )
    bl_options = {"REGISTER", "UNDO"}
    ...
    def execute(self, context):
        disable_particles_in_viewport()
        return {"FINISHED"}


class OBJECT_OT_enable_particle_in_viewport(bpy.types.Operator):
    bl_idname = "object.enable_particles_in_viewport"
    bl_label = "Enable Particles in Viewport"
    bl_description = (
        "Enable all selected objects' subdivision modifiers in the viewport"
    )
    bl_options = {"REGISTER", "UNDO"}
...
def draw_func(self, context):
    ...
    layout.operator(
        OBJECT_OT_disable_particle_in_viewport.bl_idname, icon="MOD_PARTICLES"
    )

    layout.operator(
        OBJECT_OT_enable_particle_in_viewport.bl_idname, icon="MOD_PARTICLES"
    )
...
classes = [
    ...
    OBJECT_OT_disable_particle_in_viewport,
    OBJECT_OT_enable_particle_in_viewport,
]
